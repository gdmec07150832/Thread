package com.example.wolf.thread;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void threadclass(View v){
        ...
        ThreadSample theard1=new ThreadSample("线程一");
        theard1.start();
        ThreadSample theard2=new ThreadSample("线程二");
        theard2.start();
    }
    public void runnableinterface(View v){
        ...
        Thread theard1=new Thread("线程一");
        theard1.start();
        Thread theard2=new Thread("线程二");
        theard2.start();
    }
